...
export default class Utilities {
    ...
    static protectPrototype(Component) {
        ...
        for (const name in descriptors) {
            ...
            if (Object.prototype.hasOwnProperty.call(descriptor, "get")) descriptor.set = () => Logger.warn("protectPrototype", "Addon policy for plugins #5 https://github.com/RachaelSmith2/BetterDiscord-main/wiki/Addon-Policies#plugins");
